	  	...
	  	<el-tab-pane label="注册" name="register">
	  		<el-form label-position="right" label-width="80px" :rules="registerRules" :model="formLabelRegister" ref="formLabelRegister">
	  			...
	  			<el-form-item label="确认密码" prop="verifyPassword">
	  				<el-input v-model="formLabelRegister.verifyPassword" type="password" auto-complete="off" spellcheck="false"></el-input>
	  			</el-form-item>
	  		</el-form>
	  	</el-tab-pane>
	  </el-tabs>
...
export default {
	...
	methods: {
		...
		login: function() {
			this.axios.get('http://localhost/login.php', {
		...
		register: function() {
			this.axios.get('http://localhost/register.php', {
